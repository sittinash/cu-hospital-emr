<?php
	...
	class PatientEditProfile extends Controller {
		...
		function editProfile()
		{
			...
			if(!$passwordIsCorrect){
				...
				header('Location: ../declareEditPatientProfileWrongPassword');

			} else {

				$result = $this->model->updatePatientProfile(
				...
				if($result){
					...
					header('Location: ../declareEditPatientProfileSucceeds');
				} else {
					Session::set('loggedIn', 1);
					header('Location: ../declareEditPatientProfileFails');
				}
