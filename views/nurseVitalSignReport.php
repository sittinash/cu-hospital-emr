...
<html>
	<head>
		<title>CH EMR :: บันทึกผลการตรวจร่างกาย</title>
				...
				<div class="col-md-9" style="text-align:right; margin-top:4%">
					<div class="panel panel-success">
						<div class="panel-heading" style="text-align:center">
							<h3 class="panel-title">ค้นหาผลการตรวจร่างกาย</h3>
						</div>
						<div class="panel-body" style="text-align:left">
							<form class="form-inline" method="post" action="specialNurseFetchVitalSignReport">
								...
								<table class="table table-hover table-bordered"> <!-- Change class here -->
									<thead>
										...
										<tr class="warning">
											...
											<th style="text-align:center">ผลการตรวจร่างกาย</th>
										</tr>
									</thead>
									<tbody>
										<?php
											...
											while($i < $c) { 
										?>
										<tr style="text-align:center; <?php if($_SESSION["appointmentArr"][$i]['rpt_is_active'] == 0){ ?>background-color:lightgrey;<?php } ?>">
											<form method="post" action="nurseViewVitalSignReport">
												...
												<input type="hidden" name="m" value="<?php echo $_SESSION["appointmentArr"][$i++]['appoint_id']; ?>">
												<td><input type="submit" value="ลายละเอียด" class="glyphicon glyphicon-remove"></td>
											</form>
										</tr>
										<?php 
