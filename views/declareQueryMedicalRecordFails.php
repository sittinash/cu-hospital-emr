...
<html>
	<head>
		<title>CH EMR :: เข้าสู่ระบบ</title>
					...
					<div class="panel panel-success">
						...
						<div class="panel-body">
							<div class="row" style="text-align:center;">
								ไม่พบประวัติการรักษาของผู้ป่วย กรุณาลองใหม่อีกครั้ง
								<br><br>	
								<a href="declareQueryMedicalRecordFails/acknowledge" class="btn btn-success">ย้อนกลับ<a>
							</div>
						</div>
					</div>
				<div class="col-md-3"></div>
