...
<html>
	<head>
		<title>CH EMR :: ผลการตรวจร่างกาย</title>
				...
				<div class="col-md-9" style="text-align:right; margin-top:4%">
					<div class="panel panel-success">
						...
						<div class="panel-body" style="text-align:left">
							<div>
								<form class="form-horizontal" method="post" action="specialSubmitVitalSignReport">
									<div class="row">
									...
									<div class="row" id="diagnosisPanel" style="display:none">
										<div class="col-md-1"> </div>
										<div class="col-md-10">
											<div class="form-group" style="margin-top:15px">
												<label class="col-md-2 control-label">โรค</label>
												<div class="col-md-10">
													<input type="text" class="form-control" name="disease" value="<?php echo Session::get('medicalRecordInfoArr')['disease']; ?>" disabled>
												</div>
											</div>
											<div class="form-group" style="margin-top:15px">
												<label class="col-md-2 control-label">อาการผู้ป่วย</label>
												<div class="col-md-10">
													<textarea class="form-control" style="resize: none;" rows="2" name="patientCondition" maxlength=255 disabled><?php echo Session::get('medicalRecordInfoArr')['patient_condition']; ?></textarea>
												</div>
											</div>
											<!--div class="form-group" style="margin-top:15px">
											...
											<div class="form-group" style="margin-top:15px">
												...
												<div class="col-md-10">
													<textarea class="form-control" style="resize: none;" rows="2" name="diagnosis" maxlength=255 disabled><?php echo Session::get('medicalRecordInfoArr')['diagnosis']; ?></textarea>
												</div>
											</div>
											<div class="form-group" style="margin-top:15px">
												<label class="col-md-2 control-label">หมายเหตุ</label>
												<div class="col-md-10">
													<textarea class="form-control" style="resize: none;" rows="2" name="remark" maxlength=255 disabled><?php echo Session::get('medicalRecordInfoArr')['remark']; ?></textarea>
												</div>
											</div>
										</div>
										<div class="col-md-1"> </div>
									</div>
									<div class="row" id="vitalPanel">
											<div class="row">
												<div class="col-md-1"> </div>
												<div class="col-md-5"> <!--Left Side-->
													<div class="form-group">
														...
														<div class="col-md-7">
															<input type="text" class="form-control" name="weight" value="<?php echo Session::get('vitalSignReportInfoArr')['rpt_weight']; ?>">
														</div>
													</div>
													<div class="form-group">
														<label class="col-md-5 control-label">ความดันโลหิต</label>
														<div class="col-md-7">
															<input type="text" class="form-control" name="pressure" value="<?php echo Session::get('vitalSignReportInfoArr')['rpt_min_pressure']; ?>/<?php echo Session::get('vitalSignReportInfoArr')['rpt_max_pressure']; ?> มม.ปรอท">
														</div>
													</div>
												</div>
												<div class="col-md-5"> <!--Right side-->
													<div class="form-group">
														...
														<div class="col-md-7">
															<input type="text" class="form-control" name="height" value="<?php echo Session::get('vitalSignReportInfoArr')['rpt_height']; ?> ซม.">
														</div>
													</div>
													<div class="form-group">
														<label class="col-md-5 control-label">อุณหภูมิร่างกาย</label>
														<div class="col-md-7">
															<input type="text" class="form-control" name="temper" value="<?php echo Session::get('vitalSignReportInfoArr')['rpt_termo']; ?> องศาเซลเซียส">
														</div>
													</div>
												</div>
												<div class="col-md-1"> </div>
											...
											<div class="row">
												...
												<div class="col-md-10">
													<div class="form-group">
														...
														<div class="col-md-9">
															<input type="text" class="form-control" name="pulse" value="HR <?php echo Session::get('vitalSignReportInfoArr')['rpt_pulse']; ?> bpm">
														</div>
													</div>
													<div class="form-group" style="margin-top:15px">
														<label class="col-md-3 control-label">อาการนำ</label>
														<div class="col-md-9">
															<textarea class="form-control" style="resize: none;" rows="2" name="precondition" maxlength=255><?php echo Session::get('vitalSignReportInfoArr')['rpt_precondition']; ?></textarea>
														</div>
													</div>
													<div class="form-group" style="margin-top:15px">
														<label class="col-md-3 control-label">หมายเหตุ</label>
														<div class="col-md-9">
															<textarea class="form-control" style="resize: none;" rows="2" name="rptRemark" maxlength=255><?php echo Session::get('vitalSignReportInfoArr')['rpt_remark']; ?></textarea>
														</div>
													</div>
												</div>
												<div class="col-md-1"> </div>
									...
									<center>
										...
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<input class="btn btn-danger" type="submit" value="ยืนยัน">
									</center>
								</form>
							</div>
						</div>
