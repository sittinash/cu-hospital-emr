						...
						<div class="panel-body" style="text-align:left">
							<div>
									...
									<div class="row" id="diagnosisPanel">
										...
										<div class="col-md-10">
											<div class="form-group" style="margin-top:15px">
												...
												<div class="col-md-10">
													<input type="text" class="form-control" value="<?php echo Session::get('medicalRecordInfoArr')['disease']; ?>" disabled>
												</div>
											</div>
											<div class="form-group" style="margin-top:15px">
												<label class="col-md-2 control-label">อาการผู้ป่วย</label>
												<div class="col-md-10">
													<textarea class="form-control" style="resize: none;" rows="2" placeholder="" maxlength=255 disabled><?php echo Session::get('medicalRecordInfoArr')['patient_condition']; ?></textarea>
												</div>
											</div>
											<!--div class="form-group" style="margin-top:15px">
											...
											<div class="form-group" style="margin-top:15px">
												...
												<div class="col-md-10">
													<textarea class="form-control" style="resize: none;" rows="2" placeholder="" maxlength=255 disabled><?php echo Session::get('medicalRecordInfoArr')['diagnosis']; ?></textarea>
												</div>
											</div>
											<div class="form-group" style="margin-top:15px">
												<label class="col-md-2 control-label">หมายเหตุ</label>
												<div class="col-md-10">
													<textarea class="form-control" style="resize: none;" rows="2" placeholder="" maxlength=255 disabled><?php echo Session::get('medicalRecordInfoArr')['remark']; ?></textarea>
												</div>
											</div>
										</div>
										<div class="col-md-1"> </div>
								...
								<center>
									...
									<a href="
									<?php
										if($role=="doctor" || $role=="nurse" || $role=="officer")
											echo './staffMedicalRecord';
										else if($role=="patient") 
											echo './patientMedicalRecord';	
									?>
