				...
				<div class="col-md-9" style="text-align:right; margin-top:4%">
					<div class="panel panel-success">
						...
						<div class="panel-body" style="text-align:left">
							<div>
								<form class="form-horizontal" method="post" action="specialDispense">
									<div class="row">
									...
									<div class="table-responsive" id="prescriptionPanel" style="">
									...
									<center>
										...
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<input type="hidden" name="prescriptionToDispense" value="<?php echo Session::get('prescriptionInfoArr')[0]['presc_id']; ?>">
