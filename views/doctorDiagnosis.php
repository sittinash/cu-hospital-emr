				...
				<div class="col-md-9" style="text-align:right; margin-top:4%">
					<div class="panel panel-success">
						...
						<div class="panel-body" style="text-align:left">
							<div>
								<form class="form-horizontal" method="post" action="specialSubmitDiagnosis">
									<div class="row">
									...
									<div class="row" id="diagnosisPanel">
										...
										<div class="col-md-10">
											<div class="form-group" style="margin-top:15px">
												...
												<div class="col-md-10">
													<input type="text" class="form-control" name="disease" value="<?php echo Session::get('medicalRecordInfoArr')['disease']; ?>">
												</div>
											</div>
											<div class="form-group" style="margin-top:15px">
